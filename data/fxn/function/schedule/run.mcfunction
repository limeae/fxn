...
$execute if score loops ftemp matches 1.. store result score scheduletime ftemp run data get storage fxn:schedule list[$(index)].timedelta
$execute if score loops ftemp matches 1.. store result storage fxn:schedule list[$(index)].gametime int 1 run scoreboard players operation scheduletime ftemp += gametime ftemp

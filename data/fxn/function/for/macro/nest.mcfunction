...
#
#save nest path
$data modify storage fxn:for cmd.path.command set value "execute if data storage fxn:for nest.list[$(path)] run function fxn:for/macro/nest with storage fxn:for nest.list[$(path)]"
